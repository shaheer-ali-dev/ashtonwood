...
const STRIPE_LINK = 'https://buy.stripe.com/dRm7sNgwkdgkckj9LL8N20a'
...
export default function Agreement() {
  ...
  // 9-month agreement exact content (based on provided TOS)
  const AGREEMENT_TEXT = `
By signing below, you agree to pay the full program fee of USD $900.00 + Applicable sales tax (either upfront, or in monthly payments of USD $75.00 + Applicable sales tax for the next two months remaining to pay off the total program cost of USD $900.00).
...
You may choose to pay in full upfront or in 9 equal monthly payments of USD $75.00 + Applicable sales tax.
...
`
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let y = 40
      ctx.fillText('SCULPT 9-Month Coaching Agreement', 40, y)
      y += 30
      ...
      const filename = `agreement_9month_${form.clientName.replace(/\s/g,'_')}_${form.date}.png`
